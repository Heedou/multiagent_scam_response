...
ScamCatcher For All is an LLM-based multi-agent framework designed for end-to-end online scam response.

The framework proactively blocks or detects scam-related content in real time across communication channels such as phone calls and text messages. When preventive measures fail, it rapidly reports relevant information to law enforcement agencies and security teams, integrating the full scam response pipeline including prevention, emergency response, and investigation.

By enabling multiple stakeholders to jointly leverage the agentic capabilities of LLMs, ScamCatcher For All facilitates rapid inter-agency information sharing and analysis, helping prevent scams and minimize harm to victims.
...
#### Emergency Report Summarization task
...
#### Criminal Hypothesis Evaluation task
...
```python
python train_scamcatcher.py -oc [model name]
```


## Link to Dataset
https://drive.google.com/file/d/19Nqb5GBIaceB6-Wz6nc6UOTHjD5kPgYC/view?usp=drive_link
